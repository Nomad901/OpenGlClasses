...
void Shader::init(const std::filesystem::path& pPath)
{
...
void Shader::setUniform1iv(std::string_view pName, uint32_t pCount, const GLint* pValue)
{
	GLCall(glUniform1iv(getUniformLocation(pName), pCount, pValue));
}
...
GLint Shader::getUniformLocation(std::string_view pName)
{
