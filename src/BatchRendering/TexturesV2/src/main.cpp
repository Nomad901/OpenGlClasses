...
int32_t main(int32_t argc, int8_t* argv[])
{
...

	{
		...
		float vertices[] =
		{
			-6.0f, -6.0f, -9.0f, 0.12f, 0.32f, 1.0f,  1.0f, 0.0f, 0.0f, 0.0f,
			 6.0f, -6.0f, -9.0f, 0.42f, 0.23f, 1.0f,  1.0f,	1.0f, 0.0f,	0.0f,
			 6.0f,  6.0f, -9.0f, 1.0f,  1.0f,  0.32f, 1.0f,	1.0f, 1.0f,	0.0f,
			-6.0f,  6.0f, -9.0f, 0.63f, 1.0f,  0.12f, 1.0f,	0.0f, 1.0f,	0.0f,

			-3.0f, -3.0f, -19.0f, 1.00f, 0.43f, 1.0f, 1.0f, 0.0f, 0.0f, 1.0f, 
			 3.0f, -3.0f, -19.0f, 1.00f, 0.13f, 1.0f, 1.0f,	1.0f, 0.0f,	1.0f,
			 3.0f,  3.0f, -19.0f, 0.65f, 1.0f,	1.0f, 1.0f,	1.0f, 1.0f,	1.0f,
			-3.0f,  3.0f, -19.0f, 0.12f, 1.0f,	1.0f, 1.0f,	0.0f, 1.0f,	1.0f
		};
		...
		VBO.init(vertices, 10 * 8 * sizeof(float));
		VertexBufferLayout VBOLayout;
		VBOLayout.push(GL_FLOAT, 3);
		VBOLayout.push(GL_FLOAT, 4);
		VBOLayout.push(GL_FLOAT, 2);
		VBOLayout.push(GL_FLOAT, 1);
		...
		shader.setUniform1iv("uTexture", 2, textures);
