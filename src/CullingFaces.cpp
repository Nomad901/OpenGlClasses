...
void Program::initModels()
{
	mModelProperties.mModel.push_back(std::make_unique<Model>(glm::vec3(2.0f), mMaterialProperties.mMaterial.get(),
															  ...
															  std::vector<Texture2>()));
	mModelProperties.mModel.push_back(std::make_unique<Model>(glm::vec3(2.0f), mMaterialProperties.mMaterial.get(),
															  mProgramProperties.mResourcePath + "Models/monkeyTriangle.obj",
															  std::vector<Texture2>()));
}
...
void Program::setModels()
{
	...
	mModelProperties.mModel[1]->initMVP(mProgramProperties.mWindowWidth, mProgramProperties.mWindowHeight,
										mProgramProperties.mCamera.getViewMatrix(),
										glm::vec3(5.0f, 5.0f, 5.0f),
										std::make_pair(1.0f, glm::vec3(0.0f, 1.0f, 0.0f)),
										glm::vec3(5.0f, 5.0f, 5.0f));
	mModelProperties.mModel[1]->setUniforms(mProgramProperties.mCamera.getPos(), mProgramProperties.mCamera.getViewMatrix(),
											glm::vec4(1.0f, 1.0f, 1.0f, 1.0f), mProgramProperties.mShader,
											*mMaterialProperties.mMaterial.get(), true);
	mModelProperties.mModel[1]->render();
