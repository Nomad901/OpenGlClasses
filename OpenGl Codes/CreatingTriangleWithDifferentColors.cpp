...
void vertexSpecification()
{
	...
	////
	//// generating VAO
	//glGenVertexArrays(0, &gVertexArrayObject);
	//// selecting VAO
	...
	//glGenBuffers(0, &gVertexBufferObject);
	//glBindBuffer(GL_ARRAY_BUFFER, gVertexBufferObject);
	//// copying our data on the CPU
	//glBufferData(GL_ARRAY_BUFFER,
	//	vertexData.size() * sizeof(GLfloat), // in bytes
	//	vertexData.data(),
	...
	//	GL_FALSE,
	//	3,
	//	(void*)0); // offset from the beginning of the data
